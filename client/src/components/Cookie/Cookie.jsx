    ...
    return (
        <div className='cookie-page-container'>
            ...
            <ul>
                ...
                <li><strong>Analytics cookies:</strong> These cookies help us understand how visitors interact with our Website, helping us to improve our services.</li>
                <li><strong>Advertising cookies:</strong> These cookies are used to make advertising messages more relevant to you.</li>
                <li><strong>Social media cookies:</strong> These cookies are used when you share information using a social media sharing button on our Website.</li>
            </ul>
